...
namespace Game.SharedKernel.Results;
...
#pragma warning disable CA1000
    public static Result<T> Success(T result) => new(true, result, global::Game.SharedKernel.Results.CustomError.None);
    ...
    //TODO: Implement [CallerLineNumber], [CallerMemberName] for fun
    public static Result<T> CustomError(CustomError customError,[CallerFilePath]string? filePath = default) => new(false, default, customError);
